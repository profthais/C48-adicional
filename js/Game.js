class Game {
  constructor() {
    ...
    //criar propriedade para colisão
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          //chamar a função de colisão entre os carros


          if (player.life <= 0) {
            this.blast = false;

            //exibir a mensagem de fim de jogo após 1 segundo
  ...
  //verificar se houve colisão do carro 2 no carro 1
